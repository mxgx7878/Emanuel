...
@section('content')
    ...
    <section class="first_name_form_section mt-4">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('dashboard.first.name.search') }}" method="get">

                        <div class="form_heading">
                            <h2>First Name</h2>

                            <div class="form-group w-50 mt-3">
                                <input type="text" {{isset($name) ? 'value='.$name : ''}} class="form-control" name="name" id="firstname"
                        ...
                        <div class="all_checkboxes_options">
                            ...
                            <div class="single_checkbox_option">
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" {{(isset($searching_for) &&  $searching_for == "any" ) ? 'checked' : ''}} name="searching_for" value="any" type="checkbox"
                                            id="searching_01" onchange="updateCheckbox(this)">
                                        <label class="form-check-label" for="searching_01">
                                            Any
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="single_checkbox_option">
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" {{(isset($searching_for) &&  $searching_for == "marriage" ) ? 'checked' : ''}} name="searching_for" value="marriage"
                                            type="checkbox" id="searching_01" onchange="updateCheckbox(this)">
                                        <label class="form-check-label" for="searching_01">
                                            Marriage
                                        </label>
                                    </div>
                            ...
                            <div class="single_checkbox_option">
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" {{(isset($searching_for) &&  $searching_for == "friendship" ) ? 'checked' : ''}} name="searching_for" value="friendship"
                                            type="checkbox" id="searching_01" onchange="updateCheckbox(this)">
                                        <label class="form-check-label" for="searching_01">
                                            Friendship
                                        </label>
...
@push('js')
    <script>
        function updateCheckbox(checkbox) {
            ...
            document.querySelectorAll('input[name="searching_for"]').forEach(function(element) {
                if (element !== checkbox) {
